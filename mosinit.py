'''
Current clamp demo using Allen Brain's model 473860269.
...
from neuron473860269 import Neuron473860269
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473860269(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473860269; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-90.6875534058)
        h.fcurrent()
